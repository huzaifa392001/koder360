...
<?php include '../includes/menu.php' ?>
    ...
    <section class="serviceSec">
        ...
        <div class="serviceRow">
            <img loading="lazy" src="/assets/images/portfolio/seo/slide1.webp" alt="" class="first active">
            <img loading="lazy" src="/assets/images/portfolio/seo/slide2.webp" alt="" class="second">
            <img loading="lazy" src="/assets/images/portfolio/seo/slide3.webp" alt="" class="third">
            <img loading="lazy" src="/assets/images/portfolio/seo/slide4.webp" alt="" class="forth">
    ...
    <section class="portfolioSec">
        ...
        <ul class="portfoliowrapper">
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port1.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port2.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port3.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
        ...
        <ul class="portfoliowrapper portfoliowrapper1">
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port4.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port5.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
                    <img loading="lazy" src="/assets/images/portfolio/seo/port6.webp" class="img-fluid" alt="">
                </figure>
            </li>
            <li>
                <figure>
